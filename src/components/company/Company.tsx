  ...
  return (
    <div className=" mx-auto px-[60px] font-inter w-[1440px]">
      ...
      <div className="grid grid-cols-3 gap-6 pb-[100px] mt-[50px] mx-auto">
        <div className=" rounded-lg shadow-md border-2 company ">
          <div className="flex items-center">
            <div className="bg-pink-600 p-4 mr-4">
              <img src={basketball} alt="" />
            </div>
            <div>
              <div className="flex items-center">
                <h2 className="text-lg font-semibold mr-2">Dribbble</h2>
        ...
        {/* ---------- */}
        <div className=" bg-white rounded-lg shadow-md border-2 company ">
          <div className="flex items-center">
            <div className="bg-pink-600 p-4 mr-4">
              <img src={basketball} alt="" />
            </div>
