        ...
        <div className=" heading mx-auto mt-[35.5px] flex justify-between">
          <div className="flex items-center">
            ...
            <div className="heading ">
              ...
              <p className="text-[13px]  mt-3 address">
                <span className="mx-2 text-[#fff] itag">Front-end</span>{" "}
                <span className="featured text-[#0A65CC] bg-[#E7F0FA]">Fresher</span>
              </p>
            </div>
          </div>
          <div className="flex items-center">
        ...
        <div className="container mt-8 flex">
          <div className="left-ctn max-w-[760px] ">
            ...
            <p className="mt-4 text-base">
              ...
              <span className="block mb-4">Mo ta</span>
          ...
          <div className="right-ctn w-[536px] h-[160px]  ml-6">
            <div className=" flex pt-[9px] py-8 pl-[25px] border border-collapse ml-6 rounded-lg">
             <div>
             <div className="flex items-center gap-2"> <img src={location} alt="" />{" "} <p className="font-semibold">Địa chỉ cá nhân</p></div>
            ...
            <div className=" flex pt-[9px] py-8 pl-[25px] border border-collapse ml-6 rounded-t-lg mt-8">
              <div className="">
                ...
                <div className="flex items-center gap-2 mt-3">
                  <p>Technical:</p>
                  <span className="text-sm text-[#0BA02C] bg-[#E7F6EA] font-semibold  px-1 py-[5px] rounded">ReactJs</span>
                  <span className="text-sm text-[#0BA02C] bg-[#E7F6EA] font-semibold  px-1 py-[5px] rounded">NodeJs</span>
                </div>
                <div className="flex items-center gap-2 mt-3">
                  <p>Language:</p>
                  <span className="text-sm text-[#F16A1B] bg-[#FCE1D1] font-semibold  px-1 py-[5px] rounded">Japanese N2</span>
                  <span className="text-sm text-[#3A57E8] bg-[#C4CCF8] font-semibold  px-1 py-[5px] rounded">Toeic 700</span>
                </div>
                </div>           
              </div>
            </div>
